...
public class LevelSystem : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // Generate Enemies
        LevelRandomizeCompleteEvent.Trigger(EventStateType.OnEventStart, SpawnPos.transform.position);

        // Generate Player
        LevelRandomizeCompleteEvent.Trigger(EventStateType.OnEventEnd, SpawnPos.transform.position);
    }

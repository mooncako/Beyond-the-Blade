...
public class Stats : ScriptableObject
{
    ...
    [ReadOnly] public float MaxHealth => BaseMaxHealth + TempMaxHealth;

    public float BaseMaxEnergy = 10f;
    [ReadOnly] public float TempMaxEnergy = 0f;
    [ReadOnly] public float MaxEnergy => BaseMaxEnergy + TempMaxEnergy;

    public float BaseMovementSpeedMultiplier = 1;
    [ReadOnly] public float TempMovementSpeedMultiplier = 0;
    [ReadOnly] public float MovementSpeedMultiplier => BaseMovementSpeedMultiplier + TempMovementSpeedMultiplier;

    public float BaseDamageMultiplier = 1;
    [ReadOnly] public float TempDamageMultiplier = 0;
    [ReadOnly] public float DamageMultiplier => BaseDamageMultiplier + TempDamageMultiplier;

    public float BaseDamageReduction = 0;
    [ReadOnly] public float TempDamageReduction = 0f;
    [ReadOnly] public float DamageReduction => BaseDamageReduction + TempDamageReduction;

    public float BaseAttackSpeed = 1f;
    [ReadOnly] public float TempAttackSpeed = 0f;
    [ReadOnly] public float AttackSpeed => BaseAttackSpeed + TempAttackSpeed;

    public float BaseParryEnergyGain = 1.5f;
    [ReadOnly] public float TempParryEnergyGain = 0f;
    [ReadOnly] public float ParryEnergyGain => BaseParryEnergyGain + TempParryEnergyGain;

    public float BaseDashEnergyGain = .8f;
    [ReadOnly] public float TempDashEnergyGain = 0f;
    [ReadOnly] public float DashEnergyGain => BaseDashEnergyGain + TempDashEnergyGain;

    public float BaseHitStunDuration = .5f;
    [ReadOnly] public float TempHitStunDuration = 0f;
    [ReadOnly] public float HitStunDuration => BaseHitStunDuration + TempHitStunDuration;

    public float BaseRegulerStunDuration = 3f;
    [ReadOnly] public float TempRegulerStunDuration = 0f;
    [ReadOnly] public float RegulerStunDuration => BaseRegulerStunDuration + TempRegulerStunDuration;

    public float BaseResourceGainMultiplier = 1f;
    [ReadOnly] public float TempResourceGainMultiplier = 0f;
    [ReadOnly] public float ResourceGainMultiplier => BaseResourceGainMultiplier + TempResourceGainMultiplier;

    public float BaseDashForce = 1000f;
    [ReadOnly] public float TempDashForce = 0f;
    [ReadOnly] public float DashForce => BaseDashForce + TempDashForce;

    public float BaseIframeDuration = .2f;
    [ReadOnly] public float TempIframeDuration = 0f;
    [ReadOnly] public float IframeDuration => BaseIframeDuration + TempIframeDuration;
